...
git clone ${var.playbook_repository} /var/ansible_playbooks
ansible-playbook /var/ansible_playbooks/playbook.yml -i /var/ansible_playbooks/hosts \
  --extra-vars "wp_db_hostname=${local.wp_db_hostname} wp_db_name=${local.wp_db_name} \wp_db_user=${var.rds_username} wp_db_password=${var.rds_password}"
EOT
